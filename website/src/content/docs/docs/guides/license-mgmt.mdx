...
description: How to use licenses to grant end-customers access to specific application versions
sidebar:
  order: 5
---
...
<Aside type="tip">
The license management feature is currently in Beta. To request access, reach out to us on [Discord](https://discord.gg/6qqBSAWZfW) or by email at support@glasskube.com. 
</Aside>
...
<Aside type="note">
The diagram above illustrates how a license links an end-customer account to a specific set of application versions. Once the license is active, the customer will only be able to see and can only deploy the granted versions of the application.
</Aside>
