...
slug: docs/platform/license-management
sidebar:
  label: Overview
  order: 1
---
...
<Aside type="note">
  ...
  plans](/docs/subscription-management/) and [choosing the right
...
Learn how to create and manage Application Entitlements in the [Application Entitlements guide](/docs/platform/application-entitlements/).
...
Learn how to create and manage Artifact Entitlements in the [Artifact Entitlements guide](/docs/platform/artifact-entitlements/).
...
Learn how to create and manage License Keys — including how customers inject them into Docker, Helm, and registry-only deployments — in the [License Keys guide](/docs/platform/license-keys/).
...
<Aside type="tip">
  ...
  [Subscription](/docs/subscription-management/).
</Aside>
