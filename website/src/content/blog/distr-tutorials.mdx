...
import tutorialsLight from '../../assets/blog/2025-05-19-tutorials/tutorials-light.png';
import tutorialsDark from '../../assets/blog/2025-05-19-tutorials/tutorials-dark.png';
...
Find more information about the tutorials in the [Distr quickstart](/docs/quickstart/).
...
Our own [`hello-distr`](https://github.com/distr-sh/hello-distr) is made for exactly that.
...
:::tip
If your application is still on the earlier side, the [`hello-distr`](https://github.com/distr-sh/hello-distr)
