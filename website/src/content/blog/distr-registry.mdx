...
Manage and distribute container images, [Helm charts](/glossary/helm-chart/), and other [OCI artifacts](/glossary/oci-container-artifact-registry/) with license-based access control, audit logs, and a visual UI that makes [self-managed](/glossary/self-managed-software/) software distribution pretty darn simple if we do say so ourselves, built for both you and your customers.
