...
import dashboardOldLight from '../../assets/blog/2025-05-21-dashboard/distr-dashboard-light-old.webp';
import dashboardOldDark from '../../assets/blog/2025-05-21-dashboard/distr-dashboard-dark-old.webp';
import dashboardLight from '../../assets/blog/2025-05-21-dashboard/distr-dashboard-light.webp';
import dashboardDark from '../../assets/blog/2025-05-21-dashboard/distr-dashboard-dark.webp';
import {TabItem, Tabs} from '@astrojs/starlight/components';

I am Philip—an engineer working at Glasskube, which helps [software and AI companies](/glossary/isv-meaning/) distribute their applications to [self-managed environments](/glossary/self-managed-software/).
...
<ThemedImage
  ...
  lightSrc={dashboardOldLight}
  darkSrc={dashboardOldDark}
/>
...
With the recent [introduction of our container registry](/docs/product/registry/) we are now also supporting
[fully self-managed](/docs/use-cases/fully-self-managed/) environments
in addition to agent-based [assisted self-managed](/docs/use-cases/assisted-self-managed/) environments.
...
[Distr v1.6](https://github.com/distr-sh/distr/releases/tag/1.6.0).
...
so the docker compose and [Helm Charts](/glossary/helm-chart/) stay in a manageable size.
...
Deployment target metrics have been introduced in [Distr v1.9](https://github.com/distr-sh/distr/releases/tag/1.9.0).
...
Read more about the [Docker Metrics Collection](/docs/product/agents/#docker-metrics) and
[Kubernetes Metrics Collection](/docs/product/agents/#kubernetes-metrics) in our documentation.
...
The introduction of images was a rather small addition in [Distr v1.6](https://github.com/distr-sh/distr/releases/tag/1.6.0),
