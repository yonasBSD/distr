...
- **How to get started:** Check out the [guide](/docs/guides/docker-env-var-template/) on how to manage environment variables in Docker Compose files.
