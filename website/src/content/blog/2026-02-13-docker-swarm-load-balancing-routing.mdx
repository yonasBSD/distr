...
Routing is one of the reasons teams reach for Swarm over plain Compose; for the broader set of [plain-Docker-Compose-in-production trade-offs](/blog/running-docker-in-production/) that push you in that direction, I have a separate write-up.
