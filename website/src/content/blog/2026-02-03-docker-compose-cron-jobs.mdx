...
Cron jobs are one of several Compose gaps worth knowing about—I have collected the rest in [Should I Run Plain Docker Compose in Production?](/blog/running-docker-in-production/).
...
- [Kubernetes CronJobs](https://kubernetes.io/docs/core-concepts/workloads/controllers/cron-jobs/)
